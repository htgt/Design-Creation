package Test::DesignCreate::Cmd::Complete::GibsonDesignLocation;
...
# Testing
# DesignCreate::Cmd::Complete::GibsonDesignLocation ( through command line )
...
sub gibson_design_cmd : Test(4) {
    ...
    my @argv_contents = (
        ...
        '--species'             , 'Human',
        '--target-gene'         , 'GIBSON',
        '--target-end'          , 119095467,
        '--target-start'        , 119093854,
        '--strand'              , -1,
        '--chromosome'          , 11,
