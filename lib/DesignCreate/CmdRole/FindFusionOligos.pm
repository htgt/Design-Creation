...
{
    $DesignCreate::CmdRole::FindFusionOligos::VERSION = '0.046';
}
## use critic
...
const my @FIND_FUSION_OLIGOS_PARAMETERS => qw(
...
sub _build_gibson_info {
    ...
    return $FUSION_PRIMER_REGIONS{$design_method};
}
...
sub find_oligos {
    ...
    $self->add_design_parameters( \@FIND_FUSION_OLIGOS_PARAMETERS );
