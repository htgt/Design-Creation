...
{
    $DesignCreate::CmdRole::FilterFusionOligos::VERSION = '0.045';
}
## use critic
...
DesignCreate::CmdRole::FilterFusionOligos - Filter out invalid oligos
...
use DesignCreate::Constants qw( $DEFAULT_BWA_OLIGO_DIR_NAME %FUSION_PRIMER_REGIONS );
